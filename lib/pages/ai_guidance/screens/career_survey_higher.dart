...
class CareerSurveyHigher extends StatefulWidget {
  const CareerSurveyHigher({super.key});

  @override
  State<CareerSurveyHigher> createState() =>
      _CareerSurveyStateHiCareerSurveyHigher();
}

class _CareerSurveyStateHiCareerSurveyHigher extends State<CareerSurveyHigher> {
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                CustomInputField(
                  label: 'Enter the course you are currently pursuing',
                  controller: _degreeController,
                  required: true,
                  validationText: 'degree',
                ),
                SizedBox(
                ...
                CustomDropDown(
                    label: 'Enter the year you are currently in',
                    list: years,
                    onChanged: (value) {
                      _currentYear = value;
                    },
                    validationText: 'current year of study'),
                SizedBox(
                  height: screenHeight * 0.025,
                ),
                const Text(
                ...
                const Text(
                  'List activities, or topics you are passionate about or enjoy exploring. You can also type subjects you liked studying in your course.',
                  style: TextStyle(fontSize: 12),
                ),
                SizedBox(
                  height: screenHeight * 0.025,
                ...
                const Text(
                  'eg: Web development, javascript, calligraphy, etc.',
                  style: TextStyle(fontSize: 12),
                ),
                SizedBox(
                  height: screenHeight * 0.025,
                ...
                const Text(
                  'Enter subjects or topics your\'e good at. You can also enter other strengths such as creativity, leadership, etc.',
                  style: TextStyle(fontSize: 12),
                ),
                SizedBox(
                  height: screenHeight * 0.025,
                        ...
                        if (_formKey.currentState!.validate()) {
                          ...
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (ctx) => RecommendationScreen(
                                    qualifications:
                                        '${_degreeController.text} ${_streamController.text}, Current Year : $_currentYear',
