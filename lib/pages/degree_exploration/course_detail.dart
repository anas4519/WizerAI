import 'package:career_counsellor/bloc/degree_details/degree_detail_bloc.dart';
...
class _CourseDetailState extends State<CourseDetail> {
  ...
  Widget _buildSection(String title, List<String> content,
    ...
    if (title == 'Cons') {
      return ConsSection(
          title: title, content: content, career: widget.title, type: 'degree');
    }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => DegreeDetailBloc(NetworkRepository())
        ..add(LoadDegreeDetail(widget.title)),
      child: Scaffold(
        appBar: AppBar(
          title: Text(
            widget.title,
        ...
        body: BlocBuilder<DegreeDetailBloc, DegreeDetailState>(
          builder: (context, state) {
            if (state is DegreeDetailStateLoading) {
              return Center(
                child: Column(
            ...
            if (state is DegreeDetailStateError) {
              return Center(
                child: Padding(
            ...
            if (state is DegreeDetailStateLoaded) {
                  ...
                  children: [
                    ...
                    ...sections
                        .where((section) =>
                            ...
                            (state.careerDetails[section]?.isNotEmpty ?? false))
